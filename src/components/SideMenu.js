...
// Dump Data - Menu
import { menuItems, menusSecondaryItems } from '../data/menu.json';
      ...
      return(
        ...
        {/* --- Secundary MENU start --- */}
          <View style={{paddingRight: 15, paddingLeft: 15, paddingBottom: 15}}>
            ...
            <Grid>
              <Col style={{alignItems: 'center'}}><Icon style={{fontSize: 18}} name='logo-facebook' onPress={() => Linking.openURL('https://www.facebook.com/').catch(err => console.error('An error occurred', err))} /></Col>
              <Col style={{alignItems: 'center'}}><Icon style={{fontSize: 18}} name='logo-instagram' onPress={() => Linking.openURL('https://www.instagram.com/').catch(err => console.error('An error occurred', err))} /></Col>
